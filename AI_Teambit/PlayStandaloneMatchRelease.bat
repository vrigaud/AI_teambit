...
python GenAIBootCampViewerFiles.py %~dp0/StandaloneMatchResults/gamelog/GameReplay.log %~dp0/StandaloneMatchResults/gamelog/GameReplay.js %~dp0/StandaloneMatchResults/gamelog/AIBootCampResults.html
